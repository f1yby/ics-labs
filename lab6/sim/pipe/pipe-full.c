...
{
    return (((((ex_mem_curr->icode) == (I_MRMOVQ)) & ((id_ex_curr->icode)
             == (I_RMMOVQ))) & ((id_ex_curr->srca) == (ex_mem_curr->destm))
...
long long gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
          ...
          (if_id_curr->icode) == (I_RMMOVQ))) | ((I_RET) == 
